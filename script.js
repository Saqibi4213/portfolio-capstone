...
document.addEventListener('DOMContentLoaded', () => {
  const projects = [
    ...
    },
    {
      ...
      screenshots: ['images/CO1.png', 'images/CO2.png', 'images/CO3.png', 'images/CO4.png', 'images/CO5.png'],
      technologies: ['HTML', 'CSS'],
    ...
    },
    {
      ...
      screenshots: ['images/P1.png','images/P2.png', 'images/P3.png', 'images/P4.png', ,],
      technologies: ['HTML', 'CSS'],
